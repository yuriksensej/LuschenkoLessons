...
// alert(2019 - 200);//закоменировал так как мешал писать дальше код
...
document.getElementsByClassName('one')[0].innerHTML = 'Hello World';
...
document.querySelector('div.three').innerHTML = '<h3>Yurii</h3>';
...
document.querySelector('.four').innerHTML += '<h4>Yurii</h4><p>Minchenko</p>'; // не понял зачем здесь innerHTML += ..... он ведь пустой.
...
div7.innerHTML =
  '<img src="https://cdn4.iconfinder.com/data/icons/food-and-drink-flat-gradient/32/cone_ice_cream_food_drink_sweet-512.png" alt="cone_ice_cream_food_drink_sweet-512">';
