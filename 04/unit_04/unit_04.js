...
function f4() {
  let input_check = document.querySelector('.i-4').checked;
  if (input_check) {
...
function f5() {
  let input_check = document.querySelector('.i-5');
  if (input_check.checked) {
    document.querySelector('.out-5').textContent = input_check.value;
  } else {
...
function f6() {
  document.querySelector('.out-6').textContent = document.querySelector(
    '.i-6'
  ).value;
}
...
function f7() {
  ...
  document.querySelector('.out-71').textContent = pass;
  if (pass.length >= 6) {
...
function f8() {
  document.querySelector('.out-8').innerHTML =
    '<input type="text" class="i-81"><button class="button-primary b-81">B-81</button>';
...
function f81() {
  document.querySelector('.out-81').innerText = document.querySelector(
    '.i-81'
  ).value;
}
...
function f10() {
  ...
  out_10.style.background = i_10.value;
  console.log(i_10.value);
}
...
function f11() {
  let i_111 = document.querySelector('.i-111');
  let i_112 = document.querySelector('.i-112');
  i_112.value = i_111.value;
}
...
function f12() {
  let i_12 = document.querySelector('.i-12');
  let out_12 = document.querySelector('.out-12');
  out_12.textContent = i_12.value;
}
...
function f13() {
  let i_13 = document.querySelector('.i-13');
  let out_13 = document.querySelector('.out-13');
  out_13.textContent = i_13.value;
}
...
function f14() {
  let t_14 = document.querySelector('.t-14');
  let out_14 = document.querySelector('.out-14');
  out_14.textContent = t_14.value;
}
...
function f15() {
  let i_15 = document.querySelector('.i-15');
  let t_15 = document.querySelector('.t-15');
  let out_15 = document.querySelector('.out-15');
  t_15.value = out_15.textContent = i_15.value;
}
...
function f16() {
  let s_16 = document.querySelector('.s-16'),
    out_16 = document.querySelector('.out-16');
  out_16.textContent = s_16.value;
...
function f17() {
  let s_17 = document.querySelector('.s-17'),
    out_17 = document.querySelector('.out-17');
  out_17.textContent = s_17.value;
}
...
function f18() {
  let s_18 = document.querySelector('.s-18'),
    i_18 = document.querySelector('.i-18');
  i_18.value = s_18.value;
}
...
function f19() {
  let i_191 = document.querySelector('.i-191'),
    i_192 = document.querySelector('.i-192'),
    out_19 = document.querySelector('.out-19');
  out_19.textContent = `${i_191.value} ${i_192.value}`;
}
...
function f20(e) {
  ...
  let form_name = form.elements.username,
    form_pass = form.elements.password,
    form_out = document.querySelector('.out-20');
  form_out.textContent = `${form_name.value} ${form_pass.value}`;
}
