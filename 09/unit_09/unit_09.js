...
function f5() {
  document.querySelector('.out-5').textContent = Boolean(
...
function f6() {
  document.querySelector('.out-6').textContent = document.querySelectorAll(
    '.p-6'
  ).length;
}
...
function f7() {
  ...
  //   blocks7.forEach((item) => {
  //     item.classList.add('bg-7');
  //   });
  // просто проверил вторым способом...
}
...
function f18() {
  let atr_18 = document.querySelector('.p-18').getAttribute('data-b');
  document.querySelector('.out-18').textContent = atr_18;
}
...
function f19() {
  let arr_atr_19 = document.querySelectorAll('.p-19');
  let out = '';
  arr_atr_19.forEach((item) => {
