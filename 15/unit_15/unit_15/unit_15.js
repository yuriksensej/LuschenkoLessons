...
const f2 = () => {
  let iValue = document.querySelector('.i-2').value;
  s2.add(iValue);
  console.log(s2);
};
...
const f3 = () => {
  let iValue = document.querySelector('.i-3').value;
  s3.delete(iValue);
  console.log(s3);
};
...
const f4 = () => {
  let iValue = document.querySelector('.i-4').value;
  document.querySelector('.out-4').textContent = s4.has(iValue);
};
...
const f7 = () => {
  let inputPassword = document.querySelector('.i-7').value;
  let passwordUnicSet = new Set(inputPassword);
  if (
    inputPassword.length == passwordUnicSet.size &&
...
const f10 = (out_set, elem) => {
  let str = Array.from(out_set).join(' ');
