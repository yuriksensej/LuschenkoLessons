...
let ar1 = ['str', 2, true, 'Hello', 15, false]; // переменную обьявляем здесь!!!!

function f1() {
  document.querySelector('.out-1').innerHTML = ar1; //ваш_элемент.innerHTML = ar1; // да так можно выводить!!!!
}
...
let ar2 = ['str', 2, true, 'Hello', 15, false]; // переменную обьявляем здесь!!!!
...
let ar3 = ['str', 2, true, 'Hello', 15, false]; // let ar3 =  // переменную обьявляем здесь!!!!
