...
function t1() {
  let promise1 = new Promise((resolve, reject) => {
    fetch(`${serverUrl}?auth=${authKey}&action=1`).then((response) =>
      resolve(response.text())
    );
  });
  let promise2 = new Promise((resolve, reject) => {
    fetch(`${serverUrl}?auth=${authKey}&action=2&name=Yurii`).then((response) =>
      resolve(response.text())
    );
  });
  Promise.all([promise1, promise2]).then((text) => {
...
function t2() {
  let p1 = new Promise((resolve, reject) => {
    fetch(
      `${serverUrl}?auth=${authKey}&action=3&num1=7&num2=13`
    ).then((response) => resolve(response.text()));
  });
  let p2 = new Promise((resolve, reject) => {
    fetch(
      `${serverUrl}?auth=${authKey}&action=4&num1=8&num2=18`
    ).then((response) => resolve(response.text()));
  });
...
function t3() {
  let p1 = new Promise((resolve, reject) => {
    fetch(`${serverUrl}?auth=${authKey}&action=5`).then((response) =>
      resolve(response.text())
    );
  });
  let p2 = new Promise((resolve, reject) => {
    fetch(
      `${serverUrl}?auth=${authKey}&action=6&num1=7&num2=13`
    ).then((response) => resolve(response.text()));
  });
  Promise.all([p1, p2]).then((text) => {
