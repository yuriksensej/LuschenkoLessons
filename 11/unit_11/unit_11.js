...
function f9() {
  ...
  d9 = arr2;
  document.querySelector('.out-9').textContent = d9;
  showArr('.out-9', d9);
}
...
function f15() {
  ...
  if (d15.indexOf(i_15) < 0 && !isNaN(i_15)) {
    d15.push(i_15);
  }
  showArr('.out-15', d15);
}
...
function f16() {
  ...
  document.querySelector('.out-16').textContent = d16;
  showArr('.out-16', d16);
}
