...
function f3() {
  ...
  } else document.querySelector('.out-3').innerHTML = b;
}
...
function f4() {
  ...
  let age = dateNow - document.querySelector('.i-4').value;
  console.log(age);
  if (age >= 18) {
...
function f9() {
  ...
  let outputValue = document.querySelector('.out-9');
  if (inputValue >= 44 && inputValue <= 64) {
    outputValue.innerHTML = 3;
  } else if (inputValue >= 33 && inputValue <= 43) {
    outputValue.innerHTML = 2;
  } else if (inputValue >= 1 && inputValue <= 32) {
    outputValue.innerHTML = 1;
  } else {
